...
class ExperimentCreationDTO(object):
    ...
    def __init__(self, uri=None, name=None, start_date=None, end_date=None, description=None, objective=None, species=None, variables=None, organisations=None, projects=None, scientific_supervisors=None, technical_supervisors=None, groups=None, is_public=None):  # noqa: E501
