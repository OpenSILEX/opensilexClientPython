...
api_instance = opensilexClientTools.DataApi(pythonClient)
body = [opensilexClientTools.DataCreationDTO()] # list[DataCreationDTO] | Data description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.DataApi(pythonClient)
body = opensilexClientTools.ProvenanceCreationDTO() # ProvenanceCreationDTO | Provenance description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.DataApi(pythonClient)
body = [opensilexClientTools.DataFilePathCreationDTO()] # list[DataFilePathCreationDTO] | Metadata of the file
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.DataApi(pythonClient)
body = opensilexClientTools.DataUpdateDTO() # DataUpdateDTO | Data description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.DataApi(pythonClient)
body = opensilexClientTools.ProvenanceUpdateDTO() # ProvenanceUpdateDTO | Provenance description (optional)
...
api_instance = opensilexClientTools.DataApi(pythonClient)
uri = 'uri_example' # str | Data URI
body = opensilexClientTools.DataConfidenceDTO() # DataConfidenceDTO | Data description (optional)
