# opensilexClientTools.ProjectsApi
...
api_instance = opensilexClientTools.ProjectsApi(pythonClient)
body = opensilexClientTools.ProjectCreationDTO() # ProjectCreationDTO | Project description (optional)
