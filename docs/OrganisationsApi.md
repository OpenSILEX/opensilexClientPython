# opensilexClientTools.OrganisationsApi
...
api_instance = opensilexClientTools.OrganisationsApi(pythonClient)
body = opensilexClientTools.InfrastructureCreationDTO() # InfrastructureCreationDTO | Organisation description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.OrganisationsApi(pythonClient)
body = opensilexClientTools.InfrastructureFacilityCreationDTO() # InfrastructureFacilityCreationDTO | Facility description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.OrganisationsApi(pythonClient)
body = opensilexClientTools.InfrastructureTeamDTO() # InfrastructureTeamDTO | Team description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.OrganisationsApi(pythonClient)
body = opensilexClientTools.InfrastructureUpdateDTO() # InfrastructureUpdateDTO | Organisation description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.OrganisationsApi(pythonClient)
body = opensilexClientTools.InfrastructureFacilityUpdateDTO() # InfrastructureFacilityUpdateDTO | Facility description (optional)
