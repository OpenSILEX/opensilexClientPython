# opensilexClientTools.FactorsApi
...
api_instance = opensilexClientTools.FactorsApi(pythonClient)
body = opensilexClientTools.FactorCreationDTO() # FactorCreationDTO | Factor description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.FactorsApi(pythonClient)
body = opensilexClientTools.FactorUpdateDTO() # FactorUpdateDTO | Factor description (optional)
