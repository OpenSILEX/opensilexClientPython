# opensilexClientTools.EventsApi
...
body = [opensilexClientTools.EventCreationDTO()] # list[EventCreationDTO] |  (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.EventsApi(pythonClient)
body = [opensilexClientTools.MoveCreationDTO()] # list[MoveCreationDTO] |  (optional)
...
target = '\"http://www.opensilex.org/demo/2018/o18000076\"' # str | Concerned item URI (optional)
description = '\"The pest attack\"' # str | Event description regex pattern (optional)
 ...
 **target** | **str**| Concerned item URI | [optional] 
 **description** | **str**| Event description regex pattern | [optional] 
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.EventsApi(pythonClient)
body = opensilexClientTools.EventUpdateDTO() # EventUpdateDTO | Event description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.EventsApi(pythonClient)
body = opensilexClientTools.MoveUpdateDTO() # MoveUpdateDTO | Event description (optional)
