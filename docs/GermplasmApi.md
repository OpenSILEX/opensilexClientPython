# opensilexClientTools.GermplasmApi
...
body = opensilexClientTools.GermplasmCreationDTO() # GermplasmCreationDTO | Germplasm description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.GermplasmApi(pythonClient)
body = opensilexClientTools.GermplasmUpdateDTO() # GermplasmUpdateDTO | Germplasm description (optional)
