# opensilexClientTools.AnnotationsApi
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.AnnotationsApi(pythonClient)
body = opensilexClientTools.AnnotationCreationDTO() # AnnotationCreationDTO |  (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.AnnotationsApi(pythonClient)
body = opensilexClientTools.AnnotationUpdateDTO() # AnnotationUpdateDTO | Annotation description (optional)
