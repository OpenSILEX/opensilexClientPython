# opensilexClientTools.ExperimentsApi
...
api_instance = opensilexClientTools.ExperimentsApi(pythonClient)
body = opensilexClientTools.ExperimentCreationDTO() # ExperimentCreationDTO | Experiment description (optional)
