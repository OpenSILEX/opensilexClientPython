# opensilexClientTools.AuthenticationApi
...
api_instance = opensilexClientTools.AuthenticationApi(pythonClient)
body = opensilexClientTools.AuthenticationDTO() # AuthenticationDTO | User authentication informations (optional)
