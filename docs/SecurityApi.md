# opensilexClientTools.SecurityApi
...
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.GroupCreationDTO() # GroupCreationDTO | Group description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.ProfileCreationDTO() # ProfileCreationDTO | Profile description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.UserCreationDTO() # UserCreationDTO | User description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.GroupUpdateDTO() # GroupUpdateDTO | Group description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.ProfileUpdateDTO() # ProfileUpdateDTO | Profile description (optional)
...
pythonClient.connect_to_phis_ws(api_id="ws_custom",username="guest@opensilex.org",password="guest",host="https://localhost")
api_instance = opensilexClientTools.SecurityApi(pythonClient)
body = opensilexClientTools.UserUpdateDTO() # UserUpdateDTO | User description (optional)
